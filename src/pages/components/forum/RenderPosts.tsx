...
function LoadProfile({ steamId } : { steamId: string }) {
    ...
    return <div className="flex">
        {
            profile ? <img src={ profile.avatarfull } className="h-11 w-11 rounded-full mr-7" /> : <svg aria-hidden="true" className="w-8 h-8 mr-7 text-gray-200 animate-spin dark:text-gray-600 fill-violet-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
